...
//  SneakersInAir
//
//  Created by Davide Formisano on 27/02/24.
//
    ...
    var body: some View {
        ScrollView {
                    VStack(alignment: .leading, spacing: 20) {
                        Text("Privacy Policy for Kixs")
                            .font(.title)
                            .fontWeight(.bold)
                        Text("Last updated: February 27, 2024")
                        ...
                        ListItem(text: "Account means a unique account created for You to access our Service or parts of our Service.")
                        ListItem(text: "Affiliate means an entity that controls, is controlled by or is under common control with a party, where \"control\" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.")
                        ListItem(text: "Application refers to Kiss, the software program provided by the Company.")
                        ListItem(text: "Company (referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement) refers to MacBookInAir, Corso Nicolangelo Protopisani, 80146.")
                        ListItem(text: "Country refers to: Italy")
                        ListItem(text: "Device means any device that can access the Service such as a computer, a cellphone or a digital tablet.")
                        ListItem(text: "Personal Data is any information that relates to an identified or identifiable individual.")
                        ListItem(text: "Service refers to the Application.")
                        ListItem(text: "Service Provider means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used.")
                        ListItem(text: "Usage Data refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).")
                        ListItem(text: "You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.")
                        ...
                        ListItem(text: "To provide and maintain our Service, including to monitor the usage of our Service.")
                        ListItem(text: "To manage Your Account: to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.")
                        ListItem(text: "For the performance of a contract: the development, compliance and undertaking of the purchase contract for the products, items or services You have purchased or of any other contract with Us through the Service.")
                        ListItem(text: "To contact You: To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.")
                        ListItem(text: "To provide You with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.")
                        ListItem(text: "To manage Your requests: To attend and manage Your requests to Us.")
                        ...
                        ListItem(text: "For other purposes: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience.")
                        Text("We may share Your personal information in the following situations:")
                        ListItem(text: "With Service Providers: We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.")
                        ListItem(text: "For business transfers: We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.")
                        ListItem(text: "With Affiliates: We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.")
                        ListItem(text: "With business partners: We may share Your information with Our business partners to offer You certain products, services or promotions.")
                        ListItem(text: "With other users: when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.")
                        ListItem(text: "With Your consent: We may disclose Your personal information for any other purpose with Your consent.")
                        ...
                        ListItem(text: "Comply with a legal obligation")
                        ListItem(text: "Protect and defend the rights or property of the Company")
                        ListItem(text: "Prevent or investigate possible wrongdoing in connection with the Service")
                        ListItem(text: "Protect the personal safety of Users of the Service or the public")
                        ListItem(text: "Protect against legal liability")
                        ...
                        ListItem(text: "By email: MacBookInAirTeam@gmail.com")
...
struct ListItem: View {
    ...
    var body: some View {
        HStack {
            Image(systemName: "circle.fill") // Icona del punto
                .foregroundColor(.black) // Colore del punto
                .padding(.trailing, 5)
                .font(.caption)
            Text(text)
        }
